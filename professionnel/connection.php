...
if(isset($_POST['email'])) {
	...
	$results = $mysqli->query("SELECT id, Avatar, Utilisateur, Email, MotdePasse FROM youthie_professionnels WHERE Email='".$Email."' AND MotdePasse='".$MotdePasse."' ");
	...
	$mysqli->close();
	if($connectOK <> 0) {
		sleep(2); header("Location: ../accueil/");
	} else {
...
<div class="wrapper">
	...
	<main class="main fond5" style="min-height:700px;padding-top:150px;">
		...
		<section class="main_section">
			<div class="container">
				<h3>Professionnel - Se connecter</h3>
					...
					<div class="row">
						<form action="#" method="post">
							...
							<p>
								...
								<a style="color:#3CB5E8;float:right;font-size:18px" href="../pro-inscription/">S'inscrire</a><br>
							</p>
